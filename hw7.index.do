...
**semi-parametric, cox regresson adjusted for age and gender:** 
```
<<dd_do>>
...
**semi-parametric, cox regresson adjusted for age, gender, race, marital status and family annual income:** 
```
<<dd_do>>
// adjusted for age,race gender, and additionally adjusted for marital status and family annual income
capture drop s0 
